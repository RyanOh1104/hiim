...
class InputUserForm(forms.ModelForm):
    ...
    widget=forms.TextInput(attrs={'placeholder': '실명을 입력해주세요!', 'class':'all-inputs'}))
    ...
    widget=forms.Textarea(attrs={'placeholder': "'나'를 최대 3줄로 간략하게 표현해주세요!", 'rows':3, 'class':'all-inputs'}))

    insta = forms.CharField(label = "인스타그램", max_length=1000, required=False,
    widget=forms.TextInput(attrs={'placeholder': '계정을 적어주세요!', 'class':'all-inputs'}))

    facebook = forms.CharField(label = "페이스북", max_length=1000, required=False,
    widget=forms.TextInput(attrs={'placeholder': '프로필 링크를 복사하여 적어주세요!', 'class':'all-inputs'}))
    ...
    widget=forms.TextInput(attrs={'placeholder': '채널 링크를 복사하여 적어주세요!', 'class':'all-inputs'}))

    blog = forms.CharField(label = "블로그/브런치", max_length=1000, required=False,
    widget=forms.TextInput(attrs={'placeholder': '링크를 복사하여 적어주세요!', 'class':'all-inputs'}))
